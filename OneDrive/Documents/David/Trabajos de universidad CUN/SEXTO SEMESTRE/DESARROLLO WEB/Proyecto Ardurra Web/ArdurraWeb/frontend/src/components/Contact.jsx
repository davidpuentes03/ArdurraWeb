// Formulario de contacto (modo visual). No envía datos si no hay backend.
// Comentarios: para pruebas de frontend, el envío muestra una alerta.
...
export default function Contact(){
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    // Modo demo: mostrar mensaje visual en vez de enviar a servidor.
    alert('Mensaje simulado. Gracias ' + form.name + '. Pronto nos comunicaremos.');
